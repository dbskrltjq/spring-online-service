...
<div class="container my-3">
	...
	<div class="row mb-3 bg-dark p-3">
		...
		<div class="col-8 bg-dark p-3 ps-5 text-white">
			...
			<p class="m-0">
				<i class="bi ${course.reviewScore gt 0 ? 'bi-heart-fill' : 'bi-star' }"></i>
			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade show active pt-3" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
					...
					<div class="card mb-3">
						...
						<ul class="list-group list-group-flush">
						<c:forEach var="recommendation" items="${course.recommendations }">
    						<li class="list-group-item">${recommendation.target}</li>
						</c:forEach>
  						</ul>
					</div>
				</div>
